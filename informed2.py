...
def informed_search(initial, goal):
	...
	if _is_solvable(initial):
		MDH_sum_beginning = calculate_linear_conflict_beginning(initial)
...
def _heuristic_sum_old(current_state):
	...
	return calculate_linear_conflict_column(current_state) + calculate_linear_conflict_row(current_state)
...
def calculate_linear_conflict_beginning(initial):
	return calculate_linear_conflict_column(initial) + calculate_linear_conflict_row(initial)

def calculate_linear_conflict_column(initial):
	n = len(initial)
	total = 0
...
def calculate_linear_conflict_row(initial):
	n = len(initial)
	total = 0
